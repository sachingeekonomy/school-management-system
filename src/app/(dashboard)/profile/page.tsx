          ...
          <div className="w-2/3 flex flex-col justify-center gap-4">
            <div className="flex items-center gap-4">
              <h1 className="text-xl font-semibold">
                {userData?.name || user?.firstName} {userData?.surname || user?.lastName}
              </h1>
            ...
            <div className="flex items-center justify-between gap-2 flex-wrap text-xs font-medium">
              ...
              <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
                ...
                <span>{userData?.email || user?.emailAddresses[0]?.emailAddress}</span>
              </div>
              <div className="w-full md:w-1/3 lg:w-full 2xl:w-1/3 flex items-center gap-2">
        ...
        <div className="bg-white p-4 rounded-md">
          ...
          <div className="mt-4 flex flex-col gap-4">
            <div className="flex items-center justify-between">
              ...
              <span className="font-medium">{(userData as any)?.username || user?.username || "N/A"}</span>
            </div>
            <div className="flex items-center justify-between">
            ...
            <div className="flex items-center justify-between">
              ...
              <span className="font-medium">
                {(userData as any)?.createdAt ? new Date((userData as any).createdAt).toLocaleDateString() : 
